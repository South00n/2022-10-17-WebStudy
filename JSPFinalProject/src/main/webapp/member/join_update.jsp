				...
				<table class="table">
					...
					<tr>
						...
						<td width=85%><input type=date size=30 name=birthday
							class="input-sm" id="day" value="${vo.birthday }"></td>
							
					</tr>
					<tr>
						<th class="text-right" width=15%>이메일</th>
						<td width=85% class="inline"><input type=text name="email"
							id=email size=70 class="input-sm" value="${vo.email }"> <input type=button
					...
					<tr>
						...
						<td width=85% class='inline'><input type=text name=post
							id=post size=30 class="input-sm" readonly value="${vo.post }"> <input
					...
					<tr>
						...
						<td width=85% class="inline"><input type=text name=tel1
							...
							type=text name=tel2 id=tel2 size=30 class="input-sm" value="${vo.phone}"> <input
